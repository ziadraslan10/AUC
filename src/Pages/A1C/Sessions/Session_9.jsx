            ...
            <div className={`mb-2`}>
              <div className="lg:flex justify-between p-4 rounded-xl border-2 border-gray-200 ">
                <h3 className="mb-5 text-blue-400">
                  ...
                  <a
                    target="_blank"
                    href={`https://www.eslfast.com/eslread/ss/s263.htm`}
            ...
            <div className={`mb-2`}>
              <div className="lg:flex justify-between p-4 rounded-xl border-2 border-gray-200 ">
                <h3 className="mb-5">
                  ...
                  <a
                    target="_blank"
                    href={`https://www.et-foundation.co.uk/professional-development/maths-and-english/english-for-speakers-of-other-languages-esol-support/`}
                    className="text-sky-700 hover:underline  hover:text-sky-900 "
                  >
            ...
            <div className={`mb-2`}>
              <div className="lg:flex justify-between p-4 rounded-xl border-2 border-gray-200 ">
                <h3 className="mb-5">
                  ...
                  <a
                    target="_blank"
                    href={`https://www.rong-chang.com/nse/se/nse067.htm`}
                    className="text-sky-700 hover:underline  hover:text-sky-900 "
                  >
                    The Homeless man
                  </a>
            ...
            <div className={`mb-2`}>
              <div className="lg:flex justify-between p-4 rounded-xl border-2 border-gray-200 ">
                <h3 className="mb-5">
                  ...
                  <a
                    target="_blank"
                    href={`https://breakingnewsenglish.com/1408/140805-charity-challenge.html`}
                    className="text-sky-700 hover:underline  hover:text-sky-900 "
                  >
                    Charity
                  </a>
            ...
            <div className={`mb-2`}>
              <div className="lg:flex justify-between p-4 rounded-xl border-2 border-gray-200 ">
                <h3 className="mb-5">
                  ...
                  <Link
                    target="_blank"
                    to={`https://www.esl-lounge.com/student/listening/2L1-the-charity-show.php`}
                    className="text-sky-700 hover:underline  hover:text-sky-900 "
                  >
                    The Charity Show
                  </Link>
            ...
            <div className={`mb-2`}>
              <div className="lg:flex justify-between p-4 rounded-xl border-2 border-gray-200 ">
                <h3 className="mb-5">
                  ...
                  <Link
                    target="_blank"
                    to={`https://www.eslfast.com/begin4/b4/b4084.htm`}
                    className="text-sky-700 hover:underline  hover:text-sky-900 "
                  >
            ...
            <div className={`mb-2`}>
              <div className="lg:flex justify-between p-4 rounded-xl border-2 border-gray-200 ">
                <h3 className="mb-5">
                  ...
                  <Link
                    target="_blank"
                    to={`https://www.eslfast.com/begin5/b5/b5078.htm`}
                    className="text-sky-700 hover:underline  hover:text-sky-900 "
                  >
                    Doing Something Good Can Be Bad
                  </Link>
                </h3>
                <div className="flex items-center justify-center ">
                  {Listening_3 ? (
            ...
            <div className={`mb-2`}>
              <div className="lg:flex justify-between p-4 rounded-xl border-2 border-gray-200 ">
                <h3 className="mb-5">
                  ...
                  <Link
                    target="_blank"
                    to={`https://listenaminute.com/v/volunteerism.html`}
                    className="text-sky-700 hover:underline  hover:text-sky-900 "
                  >
                    Volunteerism
                  </Link>
